...
public class EventNode extends AbstractNode implements PropertyChangeListener {
    ...
    public String getHtmlDisplayName() {
        ...
        //}
        if (obj != null) {
            return "<font color='#0000FF'>Event " + obj.getIndex() + "</font>" + " <font color='AAAAAA'><i>" + obj.getDate() + "</i></font>";
        } else {
            return null;
        }
    }
    ...
    private class MyAction extends AbstractAction implements Presenter.Popup {
        ...
        public void actionPerformed(java.awt.event.ActionEvent e) {
            Event obj = getLookup().lookup(Event.class);
            JOptionPane.showMessageDialog(null, "Hello from " + obj); //To change body of generated methods, choose Tools | Templates.
        }
